...
public class CG_1BallPLUS_DEV extends SequentialCommandGroup {
  public CG_1BallPLUS_DEV(Drivetrain drivetrain, Index indexMotors, Intake intakeMotor, Launcher launcher) {
    addCommands(
