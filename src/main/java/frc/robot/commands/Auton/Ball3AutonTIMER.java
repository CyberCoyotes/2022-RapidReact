...
public class Ball3AutonTIMER extends SequentialCommandGroup {
  public Ball3AutonTIMER(Drivetrain drivetrain, Index indexMotors, Intake intakeMotor, Launcher launcher) {
    ...
    addCommands(
      ...
      /** TODO commenting this out for now, test everything first, then we'll add on this part. 
