 ...
 */
public class XHighLaunch extends SequentialCommandGroup{
/**
 ...
 * @param launcher
 */
  public XHighLaunch(Drivetrain m_drivetrain, Index indexMotors, Intake intakeMotor, Launcher launcher) {
