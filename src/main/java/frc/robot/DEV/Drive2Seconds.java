...
public class Drive2Seconds extends SequentialCommandGroup {
  ...
  public Drive2Seconds(Drivetrain drivetrain) {
    ...
    // The first "return" is forwards speed, the second "return" is left-speed, and the third "return" is turn speed.
    addCommands(new ParallelDeadlineGroup(new WaitCommand(8), new DriveCommand(drivetrain, () -> {return 0.7;}, () -> {return 0;}, () -> {return 0.0;})));
  }
}
